...
airporbepath = "/home/hammel/Build/gsm/airprobe-hopping/gsm-receiver"
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def gsm_receiver( self, input_rate = 400e3):
        ...
        print self.options
        receiver       = gsm.receiver_cf( tuner_callback, synchronizer_callback, self.options.osr, self.options.key.replace(' ', '').lower(), configuration=self.options.configuration.upper(), maio=3, hsn=12, key="", ma=0x3d)
